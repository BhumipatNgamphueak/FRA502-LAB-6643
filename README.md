...
```bash
# Clone the repository (folder will be named FRA502-LAB-6643)
...
**Note:** The workspace folder name doesn't matter - the system uses ROS2's package discovery to locate resources automatically.
